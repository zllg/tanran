...
function themeoptions_admin_menu() {
	// 在控制面板的侧边栏添加设置选项页链接
	add_theme_page('坦然智慧主题设置', '坦然智慧主题设置','edit_themes', basename(__FILE__), 'themeoptions_page');
}
    ...
    <form method="post" action="">
      ...
      <div class="content-wrap content1">
        ...
        <div class="row clearfix popular_show" style="display:none">
          ...
          <div class="fr right-wrap">
            <textarea id="custom_label" name="custom_label" rows="8" cols="100" placeholder="例如：<a href='https://www.weipxiu.com'>坦然智慧前端技术博客</a>"><?php echo $a_options['custom_label']; ?></textarea>
