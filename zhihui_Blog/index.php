...
<link rel="canonical" href="https://www.llg.design/" />
		...
		<div id="mobil">
			...
			<div class="swiper-container1">
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background:url('/wp-content/themes/Art_Blog/images/banner1.png') no-repeat center top; background-size:100% 100%"><a href="https://www.llg.design/"></a></div>
					<div class="swiper-slide" style="background:url('/wp-content/themes/Art_Blog/images/banner2.png') no-repeat center top; background-size:100% 100%"><a href="https://www.llg.design/"></a></div>
					<div class="swiper-slide" style="background:url('/wp-content/themes/Art_Blog/images/banner3.png') no-repeat center top; background-size:100% 100%"><a href="https://www.llg.design/"></a></div>
				</div>
		...
		<div class="continar-left" id="ajax_centent">
			...
			<div class="mod-index__feature" style="display: none">
				<div class="img_list_6pic ui-clearfix">
					<div class="img_box">
						<a href="https://www.llg.design/" target="_blank">
					...
					<a href="http://www.llg.design/" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_small word_display" target="_blank">
					...
					<a href="https://www.llg.design/" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_small" target="_blank">
					...
					<a href="https://www.llg.design/" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_long word_display" target="_blank">
					...
					<a href="https://www.llg.design/" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_small word_display" target="_blank">
						<div class="carousel_small_str txt_bg02">
					...
					<a href="https://www.llg.design/" target="_blank" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_long">
					...
					<a href="https://www.llg.design/" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_small" target="_blank">
						<div class="carousel_small_str txt_bg06">
							<h3 class="img_txt_title">青春</h3>
							<p class="img_p">携手梦想<br>拼搏向上</p>
						</div>
					...
					<a href="https://www.llg.design/" class="small_pic_wrap carousel_pic_wrap small_pic_wrap_small" target="_blank">
						<div class="carousel_small_str txt_bg06">
							<h3 class="img_txt_title">生活</h3>
							<p class="img_p">日子都是清净<br>抬头遇见柔情</p>
						</div>
			...
			<aside class="blog">
				...
				<div class="textwidget">
					<p class="clearfix">
						前端博客: <?php echo get_option('weipxiu_options')['domain']; ?>，我们关注Web前端开发技术，移动前端开发，前端资讯，同时分享前端资源和工具等，期待你的参与，<a rel="nofollow" target="_blank" href="https://www.llg.design/%E5%85%B3%E4%BA%8E%E5%8D%9A%E5%AE%A2/">了解更多...</a>
					</p>
					<ul class="social">
						<li class="weibo">
							<a href="https://wpa.qq.com/msgrd?v=3&uin=420176524&site=qq&menu=yes" target="_blank" class="top-tip" title="加QQ为好友"><i class="iconfont icon-qq"></i>会话</a>
						</li>
						<li class="qq">
							<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5O1Nkny" rel="nofollow" class="top-tip" title="加入web前端QQ群"><i class="iconfont icon-qqqun"></i>Q群</a>
						</li>
						<li class="email">
							<a href="mailto:<?php echo get_option('weipxiu_options')['QQ-number']; ?>420176524@qq.com" target="_blank" rel="nofollow" class="top-tip" title="给我发送qq邮件"><i class="iconfont icon-youxiang"></i>邮件</a>
						</li>
						<li class="weixin">
							<a href="javascript:;" target="_blank" rel="nofollow" class="top-tip" title="关注微信"><i class="iconfont icon-weixin"></i>微信</a>
						</li>
						<li class="feed">
							<a target="_blank" href="#" rel="nofollow" class="top-tip" title="Github"><i class="iconfont icon-qq"></i>Github</a>
						</li>
					</ul>
				</div>
			</aside>
...
if(!"<?php bloginfo('template_url'); ?>".includes('wp-content/themes/zhihui_Blog')){
		layer.alert('Sorry，当前主题安装路径不正确，详情点击确认查看github主题使用说明！',{
		skin: 'layui',
		title:"提示",
		closeBtn: 1, //是否展示关闭x按钮
		anim: 4,
		btn: ['确认'],
		yes:function(){
			location.href="http://www.llg.design/"
		}
	})
}
